...
print
  ...
  li("GapMind for",
     a( {href => "http://papers.genomics.lbl.gov/cgi-bin/gapView.cgi?gdb=FitnessBrowser&gid=$orgId&set=aa",
         title => "Annotate amino acid biosynthesis pathways"},
        "amino acid biosynthesis"),
     "or",
     a( {href => "http://papers.genomics.lbl.gov/cgi-bin/gapView.cgi?gdb=FitnessBrowser&gid=$orgId&set=carbon",
         title => "Annotate pathways for catabolism of small carbon sources"},
        "carbon catabolism")),
